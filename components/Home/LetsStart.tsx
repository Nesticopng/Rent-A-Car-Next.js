  ...
  return (
    <div className="relative w-full h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center text-white md:mt-[-13%] 2xl:mt-[-23%]">
        <h1 className="sm:text-4xl font-bold md:text-7xl 2xl:text-8xl">Start Your Journey</h1>
        <p className="mt-4 text-lg md:text-2xl">Discover the perfect car for your next adventure.</p>
        <div className="mt-8">
