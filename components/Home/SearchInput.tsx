...
function SearchInput() {
  return (
        <div className='mt-8 md:mt-5' id="cars-section">
                ...
                <div className='flex bg-gray-100 p-1 px-5 gap-2 rounded-full divide-x'>
                    <div className='flex items-center'>
                        ...
                        <input 
                            ...
                            className='p-2 outline-none bg-transparent w-full sm:w-auto'
                        />
                    </div>
                    <div>
                        <input 
                            type="date"
                            className='p-2 outline-none bg-transparent text-black'
